...
import { BodyError, CustomError, HeadersError, ParamsError, QueryError } from '~shared/helpers/error';
import { ValidationError } from '~shared/helpers/validation/error';
import { ICustomError, INext, IRequest, IResponse } from '~shared/shared.types';
